...
ticket_user_association = db.Table(
    'ticket_user_association',
...
class Company(db.Model):
    ...
    creator = db.relationship('User', backref=db.backref('created_companies', lazy=True))
...
class Ticket(db.Model):
    ...
    assigned_users = db.relationship('User', secondary=ticket_user_association, backref=db.backref('assigned_tickets', lazy='dynamic'))
    ...
    def to_dict(self):
        return {
            ...
            'assigned_users': [user.to_dict() for user in self.assigned_users]
        }
