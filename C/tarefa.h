...
//estrutura
typedef struct {                                                                //estrutura Tarefa
    int id;                                                                     //o n° em que está salvo
    char descricao[100];                                                        //descrição feita pelo usuario
...
void removerTarefa() {
    ...
    int indice = buscarIndiceTarefaPorId(id_tarefa);
    if (indice != -1) {
        tarefas[indice].id = -1;                                                //marca como livre
...
//filtra tarefas por status (esta concluída ou não)
void filtrarPorStatus() {
    int status_filtro;
